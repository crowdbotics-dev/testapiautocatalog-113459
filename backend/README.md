...
## Project Structure
    ...
    ├── testapiautocatalog_113459  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_113459`
...
2. Clone this repo and `cd testapiautocatalog_113459`
